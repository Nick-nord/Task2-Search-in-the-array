...
#include <iostream>
int NumberElements(int* Arr, int ref_point);
...
int main()
{
    ...
    std::cin >> ref_point;
    std::cout << "The number of elements in the array is greater than " << ref_point << ": " << NumberElements(Arr, ref_point);
